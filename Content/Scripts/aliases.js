...
try { let fnprepatch_740 = TemplateSequenceActor.prototype.SetBinding;TemplateSequenceActor.prototype.SetBinding = function (Actor, bOverridesDefault = true) { return fnprepatch_740.call(this, Actor, bOverridesDefault) }; } catch (e) {};
try { let fnprepatch_741 = MatineeCameraShake.prototype.StartMatineeCameraShakeFromSource;MatineeCameraShake.prototype.StartMatineeCameraShakeFromSource = function (PlayerCameraManager, ShakeClass, SourceComponent, Scale = 1, PlaySpace = "CameraLocal", UserPlaySpaceRot) { return fnprepatch_741.call(this, PlayerCameraManager, ShakeClass, SourceComponent, Scale, PlaySpace, UserPlaySpaceRot) }; } catch (e) {};
try { let fnprepatch_742 = MatineeCameraShake.prototype.StartMatineeCameraShake;MatineeCameraShake.prototype.StartMatineeCameraShake = function (PlayerCameraManager, ShakeClass, Scale = 1, PlaySpace = "CameraLocal", UserPlaySpaceRot) { return fnprepatch_742.call(this, PlayerCameraManager, ShakeClass, Scale, PlaySpace, UserPlaySpaceRot) }; } catch (e) {};
try { let fnprepatch_743 = PaperFlipbook.prototype.GetSpriteAtTime;PaperFlipbook.prototype.GetSpriteAtTime = function (Time, bClampToEnds = false) { return fnprepatch_743.call(this, Time, bClampToEnds) }; } catch (e) {};
try { let fnprepatch_744 = PaperFlipbook.prototype.GetKeyFrameIndexAtTime;PaperFlipbook.prototype.GetKeyFrameIndexAtTime = function (Time, bClampToEnds = false) { return fnprepatch_744.call(this, Time, bClampToEnds) }; } catch (e) {};
try { let fnprepatch_745 = PaperGroupedSpriteComponent.prototype.UpdateInstanceTransform;PaperGroupedSpriteComponent.prototype.UpdateInstanceTransform = function (InstanceIndex, NewInstanceTransform, bWorldSpace = false, bMarkRenderStateDirty = true, bTeleport = false) { return fnprepatch_745.call(this, InstanceIndex, NewInstanceTransform, bWorldSpace, bMarkRenderStateDirty, bTeleport) }; } catch (e) {};
try { let fnprepatch_746 = PaperGroupedSpriteComponent.prototype.UpdateInstanceColor;PaperGroupedSpriteComponent.prototype.UpdateInstanceColor = function (InstanceIndex, NewInstanceColor, bMarkRenderStateDirty = true) { return fnprepatch_746.call(this, InstanceIndex, NewInstanceColor, bMarkRenderStateDirty) }; } catch (e) {};
try { let fnprepatch_747 = PaperGroupedSpriteComponent.prototype.GetInstanceTransform;PaperGroupedSpriteComponent.prototype.GetInstanceTransform = function (InstanceIndex, OutInstanceTransform, bWorldSpace = false) { return fnprepatch_747.call(this, InstanceIndex, OutInstanceTransform, bWorldSpace) }; } catch (e) {};
try { let fnprepatch_748 = PaperGroupedSpriteComponent.prototype.AddInstance;PaperGroupedSpriteComponent.prototype.AddInstance = function (Transform, Sprite, bWorldSpace = false, Color = {"R":1,"G":1,"B":1,"A":1}) { return fnprepatch_748.call(this, Transform, Sprite, bWorldSpace, Color) }; } catch (e) {};
try { let fnprepatch_749 = PaperTileMapComponent.prototype.SetLayerColor;PaperTileMapComponent.prototype.SetLayerColor = function (NewColor, Layer = 0) { return fnprepatch_749.call(this, NewColor, Layer) }; } catch (e) {};
try { let fnprepatch_750 = PaperTileMapComponent.prototype.SetLayerCollision;PaperTileMapComponent.prototype.SetLayerCollision = function (Layer = 0, bHasCollision = true, bOverrideThickness = true, CustomThickness = 50, bOverrideOffset = false, CustomOffset = 0, bRebuildCollision = true) { return fnprepatch_750.call(this, Layer, bHasCollision, bOverrideThickness, CustomThickness, bOverrideOffset, CustomOffset, bRebuildCollision) }; } catch (e) {};
try { let fnprepatch_751 = PaperTileMapComponent.prototype.SetDefaultCollisionThickness;PaperTileMapComponent.prototype.SetDefaultCollisionThickness = function (Thickness, bRebuildCollision = true) { return fnprepatch_751.call(this, Thickness, bRebuildCollision) }; } catch (e) {};
try { let fnprepatch_752 = PaperTileMapComponent.prototype.GetTilePolygon;PaperTileMapComponent.prototype.GetTilePolygon = function (TileX, TileY, Points, LayerIndex = 0, bWorldSpace = false) { return fnprepatch_752.call(this, TileX, TileY, Points, LayerIndex, bWorldSpace) }; } catch (e) {};
try { let fnprepatch_753 = PaperTileMapComponent.prototype.GetTileCornerPosition;PaperTileMapComponent.prototype.GetTileCornerPosition = function (TileX, TileY, LayerIndex = 0, bWorldSpace = false) { return fnprepatch_753.call(this, TileX, TileY, LayerIndex, bWorldSpace) }; } catch (e) {};
try { let fnprepatch_754 = PaperTileMapComponent.prototype.GetTileCenterPosition;PaperTileMapComponent.prototype.GetTileCenterPosition = function (TileX, TileY, LayerIndex = 0, bWorldSpace = false) { return fnprepatch_754.call(this, TileX, TileY, LayerIndex, bWorldSpace) }; } catch (e) {};
try { let fnprepatch_755 = PaperTileMapComponent.prototype.GetLayerColor;PaperTileMapComponent.prototype.GetLayerColor = function (Layer = 0) { return fnprepatch_755.call(this, Layer) }; } catch (e) {};
try { let fnprepatch_756 = PaperTileMapComponent.prototype.CreateNewTileMap;PaperTileMapComponent.prototype.CreateNewTileMap = function (MapWidth = 4, MapHeight = 4, TileWidth = 32, TileHeight = 32, PixelsPerUnrealUnit = 1, bCreateLayer = true) { return fnprepatch_756.call(this, MapWidth, MapHeight, TileWidth, TileHeight, PixelsPerUnrealUnit, bCreateLayer) }; } catch (e) {};
...
try { let fnprepatch_758 = AsyncEditorDelay.prototype.AsyncEditorDelay;AsyncEditorDelay.prototype.AsyncEditorDelay = function (Seconds, MinimumFrames = 30) { return fnprepatch_758.call(this, Seconds, MinimumFrames) }; } catch (e) {};
try { let fnprepatch_759 = AsyncEditorWaitForGameWorld.prototype.AsyncWaitForGameWorld;AsyncEditorWaitForGameWorld.prototype.AsyncWaitForGameWorld = function (Index = 0, Server = false) { return fnprepatch_759.call(this, Index, Server) }; } catch (e) {};
try { EditorUtilityTask.prototype.BeginExecution = EditorUtilityTask.prototype.ReceiveBeginExecution; } catch (e) {};
try { let fnprepatch_760 = EditorValidatorSubsystem.prototype.ValidateAssets;EditorValidatorSubsystem.prototype.ValidateAssets = function (AssetDataList, bSkipExcludedDirectories = true, bShowIfNoFailures = true) { return fnprepatch_760.call(this, AssetDataList, bSkipExcludedDirectories, bShowIfNoFailures) }; } catch (e) {};
...
try { let fnprepatch_762 = NiagaraComponent.prototype.SetAsset;NiagaraComponent.prototype.SetAsset = function (InAsset, bResetExistingOverrideParameters = true) { return fnprepatch_762.call(this, InAsset, bResetExistingOverrideParameters) }; } catch (e) {};
...
try { let fnprepatch_763 = NiagaraFunctionLibrary.prototype.SpawnSystemAttached;NiagaraFunctionLibrary.prototype.SpawnSystemAttached = function (SystemTemplate, AttachToComponent, AttachPointName, Location, Rotation, LocationType, bAutoDestroy, bAutoActivate = true, PoolingMethod = "None", bPreCullCheck = true) { return fnprepatch_763.call(this, SystemTemplate, AttachToComponent, AttachPointName, Location, Rotation, LocationType, bAutoDestroy, bAutoActivate, PoolingMethod, bPreCullCheck) }; } catch (e) {};
try { let fnprepatch_764 = NiagaraFunctionLibrary.prototype.SpawnSystemAtLocation;NiagaraFunctionLibrary.prototype.SpawnSystemAtLocation = function (WorldContextObject, SystemTemplate, Location, Rotation, Scale, bAutoDestroy = true, bAutoActivate = true, PoolingMethod = "None", bPreCullCheck = true) { return fnprepatch_764.call(this, WorldContextObject, SystemTemplate, Location, Rotation, Scale, bAutoDestroy, bAutoActivate, PoolingMethod, bPreCullCheck) }; } catch (e) {};
...
try { let fnprepatch_765 = NiagaraClipboardEditorScriptingUtilities.prototype.TrySetLocalValueAsInt;NiagaraClipboardEditorScriptingUtilities.prototype.TrySetLocalValueAsInt = function (InInput, bOutSucceeded, InValue, bLooseTyping = true) { return fnprepatch_765.call(this, InInput, bOutSucceeded, InValue, bLooseTyping) }; } catch (e) {};
